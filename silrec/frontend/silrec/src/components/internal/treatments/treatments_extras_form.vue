<template>
    <div class="treatment-extra-form">
        <div v-if="$route.query.debug?.toLowerCase() === 'true'">
            src/components/internal/treatments/treatments_extras_form.vue
        </div>
        <form @submit.prevent="saveExtra">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        <label for="rescheduledReason" class="form-label"
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        <label for="successRate" class="form-label"
                            >Success Rate (%)</label
                        >
                        <input
                            id="successRate"
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        <label for="stockingRate" class="form-label"
                            >Stocking Rate (sph)</label
                        >
                        <input
                            id="stockingRate"
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        <label for="speciesAssessed" class="form-label"
                            >Species Assessed</label
                        >
                        <input
                            id="speciesAssessed"
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        <label for="resultStandard" class="form-label"
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label for="species1Planted" class="form-label"
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label for="plantingRate1" class="form-label"
                                    >Primary Planting Rate (sph)</label
                                >
                                <input
                                    id="plantingRate1"
                                    v-model.number="
                                        formData.zplanting_rate1_spha
                                    "
                                    type="number"
                                    min="0"
                                    step="1"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label for="species2Planted" class="form-label"
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label for="plantingRate2" class="form-label"
                                    >Secondary Planting Rate (sph)</label
                                >
                                <input
                                    id="plantingRate2"
                                    v-model.number="
                                        formData.zplanting_rate2_spha
                                    "
                                    type="number"
                                    min="0"
                                    step="1"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                <label for="seedSource" class="form-label"
                                    >Seed Source</label
                                >
                                <input
                                    id="seedSource"
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group mb-3">
                                <label for="qty1" class="form-label"
                                    >Quantity 1</label
                                >
                                <input
                                    id="qty1"
                        ...
                        <div class="col-md-3">
                            <div class="form-group mb-3">
                                <label for="qty2" class="form-label"
                                    >Quantity 2</label
                                >
                                <input
                                    id="qty2"
                        ...
                        <div class="col-md-3">
                            <div class="form-group mb-3">
                                <label for="qty3" class="form-label"
                                    >Quantity 3</label
                                >
                                <input
                                    id="qty3"
                        ...
                        <div class="col-md-3">
                            <div class="form-group mb-3">
                                <label for="qty4" class="form-label"
                                    >Quantity 4</label
                                >
                                <input
                                    id="qty4"
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                <label for="patch" class="form-label"
                                    >Patch</label
                                >
                                <input
                                    id="patch"
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                <label for="silvic" class="form-label"
                                    >Silvic Code</label
                                >
                                <input
                                    id="silvic"
...
export default {
    ...
    methods: {
        ...
        validateForm() {
            ...
            if (
                this.formData.success_rate_pct !== null &&
                (this.formData.success_rate_pct < 0 ||
                    this.formData.success_rate_pct > 100)
            ) {
                swal.fire({
                    icon: 'error',
            ...
            if (
                this.formData.stocking_rate_spha !== null &&
                this.formData.stocking_rate_spha < 0
            ) {
                swal.fire({
                    icon: 'error',
                    title: 'Validation Error',
