...
#        return cohort_id
    ...
    def create_gdf(self, write_result_to_db=False):
        '''
...
#        """)
    ...
    def assemble_gdf_result(self, gdf_result, engine):
        pass
