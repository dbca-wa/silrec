<template>
  <div class="treatment-extras-table">
    <div v-if="$route.query.debug?.toLowerCase() === 'true'">src/components/internal/treatments/treatments_extras_table.vue</div>
                JM4 {{treatmentId}}
      ...
      <table class="table table-sm table-striped">
        ...
        <tbody>
          <tr v-for="extra in treatmentExtras" :key="extra.treatment_xtra_id">
            <td>
              <span v-if="extra.rescheduled_reason" class="badge bg-secondary">
