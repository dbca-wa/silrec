        ...
        <div v-if="!loading && !error && extra" class="card">
            <div class="card-body">
                <dl class="row">
                    ...
                    <dd class="col-sm-9">
                        {{ extra.treatment_info || extra.treatment || 'N/A' }}
                    </dd>
                    ...
                    <dd class="col-sm-9">
                        {{
                            extra.stocking_rate_spha != null
                                ? extra.stocking_rate_spha
                                : 'N/A'
                        }}
                    </dd>
                    ...
                    <dd class="col-sm-9">
                        {{ extra.rescheduled_reason || 'N/A' }}
                    </dd>

                    <dt class="col-sm-3">Z Result Standard</dt>
                    <dd class="col-sm-9">
                        {{ extra.zresult_standard || 'N/A' }}
                    </dd>
    ...
    methods: {
        async fetchExtra() {
            ...
            try {
                ...
                if (!response.ok)
                    throw new Error('Failed to load treatment extra');
