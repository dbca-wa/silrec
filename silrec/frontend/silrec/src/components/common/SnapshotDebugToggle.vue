<template>
    <div
        v-if="showDebug"
        class="snapshot-debug-container"
        ...
        <div v-if="expanded" class="debug-panel">
            <div class="debug-header">
                ...
                <div class="debug-controls">
                    ...
                    >
                        <i
                            class="bi"
                            :class="enabled ? 'bi-toggle-on' : 'bi-toggle-off'"
                        ></i>
            ...
            <div v-if="enabled" class="debug-content">
                ...
                <div v-if="snapshots.length > 0" class="snapshot-list">
                            ...
                            >
                                ...
                                <div>
                                    <span class="badge bg-info"
                                        >{{
                                            snapshot.metadata?.record_counts
                                                ?.polygon || 0
                                        }}
                                        polygons</span
                                    >
                    ...
                    <div
                        v-if="selectedSnapshot && selectedSnapshot2"
                        class="mt-2"
                    >
                        <button
                ...
                <div v-if="comparisonResult" class="comparison-results mt-3">
                    ...
                    <div class="comparison-summary">
                        <div
                            class="alert"
                            :class="
                                comparisonResult.summary?.total_changes === 0
                                    ? 'alert-success'
                                    : 'alert-warning'
                            "
                        >
                            ...
                            Tables with changes:
                            {{
                                comparisonResult.summary?.tables_with_changes
                                    ?.length || 0
                            }}<br />
                            Tables unchanged:
                            {{
                                comparisonResult.summary?.tables_unchanged
                                    ?.length || 0
                            }}
                        </div>
                    </div>
                    ...
                    <div class="table-changes">
                        ...
                        >
                            <div
                                class="table-header"
                                @click="toggleTableDetails(tableName)"
                            >
                                <i
                                    class="bi"
                                    :class="
                                ...
                                <span
                                    class="badge"
                                    :class="
                                        tableComp.has_changes
                                            ? 'bg-warning'
                                            : 'bg-success'
                                    "
                                >
                                    {{ tableComp.count_before }} →
                                    {{ tableComp.count_after }}
                                </span>
                            </div>
                            ...
                            >
                                ...
                                <div
                                    v-if="
                                        tableComp.modified &&
                                        tableComp.modified.length > 0
                                    "
                                    class="modified-examples"
                                >
                                    <small>Modified Examples:</small>
                                    <ul>
                                        <li
                                            v-for="mod in tableComp.modified.slice(
                                                0,
                                                3
                                            )"
                                            :key="mod.id"
                                        >
                                            ...
                                            <ul>
                                                <li
                                                    v-for="diff in mod.differences.slice(
                                                        0,
                                                        2
                                                    )"
                                                    :key="diff.field"
