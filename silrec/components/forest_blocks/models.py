...
class TreatmentXtra(models.Model):
    ...
    api_species_assessed = models.CharField(max_length=5, blank=True, null=True, db_comment='Species mix (API) as determined by the assessment\nSHOULD LINK TO API SPECIES LOOKUP TABLE Done. (DW)')
