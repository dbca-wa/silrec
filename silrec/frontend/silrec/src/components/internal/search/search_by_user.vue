<template>
    <div>
        <div v-if="$route.query.debug?.toLowerCase() === 'true'">
            src/components/internal/search/search_by_user.vue
        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">
                            Select an editor to find all records associated with
                            them
                        </small>
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <select v-model="modelType" class="form-select">
                            ...
                            <option value="treatment_xtra">
                                Treatment Extras
                            </option>
                            <option value="survey_assessment_document">
                                Survey Documents
                            </option>
                            <option value="silviculturist_comment">
        ...
        <div v-if="searchPerformed && !loading" class="row mt-3">
            <div class="col-md-12">
                ...
                >
                    ...
                    <div
                        v-if="selectedModelDisplay !== 'All Records'"
                        class="mt-2 small"
                    >
    ...
    computed: {
        ...
        column_user_role: function () {
            ...
            return {
                ...
                render: function (row, type, full) {
                    return (
                        full.user_role_display || full.user_role || 'Unknown'
                    );
                },
                name: 'user_role',
            };
        ...
        column_title: function () {
            return {
                ...
                render: function (row, type, full) {
                    let title =
                        full.title || full.name || full.description || 'N/A';
            ...
            if (!isFirstSearch) {
                ...
                table.ajax.reload(null, false, (json) => {
                    ...
                    if (this.totalRecords === 0) {
                        this.showInfo(
                            'No records found for the selected user and criteria.'
                        );
                    }
                });
            } else {
                this.$nextTick(() => {
                    if (
                        ...
                        this.searchPerformed = true;
                        this.showError(
                            'Could not initialize search results table. Please try again.'
                        );
                    }
                });
            }
    ...
    watch: {
        pageSize(newSize) {
            if (
                ...
                this.$refs.search_datatable.vmDataTable.page
                    .len(newSize)
                    .draw();
            }
        },
