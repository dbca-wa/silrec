<template>
    <div class="operations-table-container">
        <div v-if="$route.query.debug?.toLowerCase() === 'true'">
            src/components/internal/operations/operations_table.vue
        </div>
...
export default {
    ...
    methods: {
        refreshData() {
            if (
                this.$refs.operations_datatable &&
                this.$refs.operations_datatable.vmDataTable
            ) {
                this.$refs.operations_datatable.vmDataTable.ajax.reload(
                    null,
                    false
                );
            }
